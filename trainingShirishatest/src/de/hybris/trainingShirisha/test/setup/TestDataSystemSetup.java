 ...
 */
package de.hybris.trainingShirisha.test.setup;
...
import de.hybris.trainingShirisha.test.constants.TrainingShirishaTestConstants;
import de.hybris.trainingShirisha.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TrainingShirishaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/trainingShirishatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/trainingShirishatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/trainingShirishatest/import/cstickets.impex");
			...
			importImpexFile(context, "/trainingShirishatest/import/csquotes.impex");
		}
	}
}
