...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/trainingShirishastorefront/electronics/en",
						"https://electronics.local:9002/trainingShirishastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/trainingShirishastorefront/electronics/en",
						"https://electronics.local:9002/trainingShirishastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/trainingShirishastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/trainingShirishastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/trainingShirishastorefront/electronics/en",
						"https://electronics.local:9002/trainingShirishastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/trainingShirishastorefront",
						"https://electronics.local:9002/trainingShirishastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/trainingShirishastorefront",
						"https://electronics.local:9002/trainingShirishastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/trainingShirishastorefront/electronics/en",
						"https://electronics.local:9002/trainingShirishastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
