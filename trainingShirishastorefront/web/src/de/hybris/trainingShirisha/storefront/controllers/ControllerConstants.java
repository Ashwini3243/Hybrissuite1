 ...
 */
package de.hybris.trainingShirisha.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			{
				String ManufactureDetails = "pages/custom/manufactureDetailsPage";
				String AllManufactureDetails = "pages/custom/allManufactureDetailsPage";
				String ManufactureDetailsByIdAndName = "pages/custom/manufactureDetailsByIdAndNamePage";
				String ManufacturePaginationData = "pages/custom/manufacturePaginationData";
				String ManufactureDetailsForm = "pages/custom/manufactureDetailsFormPage";
				String ManufactureDetailsSavedSuccess = "/pages/custom/manufactureDetailsSuccessPage";
				String RemoveManufactureDetails="/pages/custom/removePage";
			}
			interface CustomerDetails
			{
				String Last10DaysCustomerDetails = "pages/custom/customerDetailsPage";
				String CustomerDetails = "pages/custom/customerDataPage";
			}
		}
