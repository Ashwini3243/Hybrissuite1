...
import de.hybris.trainingShirisha.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/trainingShirishafulfilmentprocess/test/trainingShirishafulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/trainingShirishafulfilmentprocess/test/trainingShirishafulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/trainingShirishafulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/trainingShirishafulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/trainingShirishafulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/trainingShirishafulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/trainingShirishafulfilmentprocess/test/trainingShirishafulfilmentprocess-spring-testcleanup.xml"));
