 ...
 */
package de.hybris.trainingShirisha.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TrainingShirishaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TrainingShirishaFulfilmentProcessConstants.PARENT_PROCESS);
