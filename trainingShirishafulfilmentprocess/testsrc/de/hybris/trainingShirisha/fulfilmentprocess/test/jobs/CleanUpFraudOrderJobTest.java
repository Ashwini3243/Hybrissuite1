 ...
 */
package de.hybris.trainingShirisha.fulfilmentprocess.test.jobs;
...
import de.hybris.trainingShirisha.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TrainingShirishaFulfilmentProcessConstants.ORDER_PROCESS_NAME;
