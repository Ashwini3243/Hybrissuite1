 ...
 */
package de.hybris.trainingShirisha.core.constants;

/**
 * Global class for all TrainingShirishaCore constants. You can add global constants for your extension into this class.
 */
public final class TrainingShirishaCoreConstants extends GeneratedTrainingShirishaCoreConstants
{
	public static final String EXTENSIONNAME = "trainingShirishacore";


	private TrainingShirishaCoreConstants()
	{
		//empty
	}
